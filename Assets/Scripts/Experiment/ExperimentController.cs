...
public class ExperimentController : MonoBehaviour {
    ...
    void Start () {
        ...
        // カーソルの生成
        cursorManager.setCursors (-Settings.experimentCursorParams[Settings.experimentCount]["window"] / 2,
            Settings.experimentCursorParams[Settings.experimentCount]["window"] / 2, -Settings.experimentCursorParams[Settings.experimentCount]["window"] / 2,
